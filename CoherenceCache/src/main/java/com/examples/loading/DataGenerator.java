...
public class DataGenerator {
     ...
     * @throws IOException if file cannot be written
     */
    public static void generate(OutputStream out, int cContacts)throws IOException
    {
	...
	return new Contact("John",
		getRandomName(),
		new Address("1500 Boylston St.", null, getRandomName(),getRandomState(), getRandomZip(), "US"),
		new Address("8 Yawkey Way", null, getRandomName(),getRandomState(), getRandomZip(), "US"),
